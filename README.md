...
> Professional AI-powered sensitivity generator for PUBG Mobile. مُحسّن PUBG Mobile الأردني — مولّد حساسية ذكاء اصطناعي احترافي.

![Version](https://img.shields.io/badge/version-2026-ff7a00) ![React](https://img.shields.io/badge/React-19.2.6-61dafb) ![Vite](https://img.shields.io/badge/Vite-7.3.2-646cff) ![Tailwind](https://img.shields.io/badge/Tailwind-4.1.17-38bdf8) ![TypeScript](https://img.shields.io/badge/TypeScript-5.9.3-3178c6) ![Languages](https://img.shields.io/badge/languages-AR%20%7C%20EN%20%7C%20TR%20%7C%20RU%20%7C%20ES-orange)

## 🎯 Overview

**ALYAZOURI 2026** is a fully client-side web application that generates optimal PUBG Mobile sensitivity settings based on:

* 📱 **112+ Devices** — Apple (iPhone + all iPads), Samsung, Xiaomi, Red Magic, ROG, OnePlus, Realme, Huawei, Honor, OPPO, Vivo, Google
* 🔫 **44 Weapons** — AR, SMG, DMR, Sniper, LMG, Shotgun, Pistol — each with calibrated recoil profile
* 🌍 **7 Servers** — Live ping monitor (Middle East, Europe, India, Asia, Korea/Japan, NA, SA)
...
### 🛡️ Live Jordan DNS Monitor
* 12 Jordanian DNS servers probed live
* Latency, jitter, online/offline status
* One-click copy IP
...
└── src/
    ...
    ├── PingMonitor.tsx        # 7-server live ping + Jordan DNS monitor
